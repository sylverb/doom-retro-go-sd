...
/* GW_CORE_BRIDGE_DISABLE_SDK_MALLOC: omit malloc/free/realloc/calloc trampolines
 * so the core can supply its own (e.g. zone heap). ahb_malloc/dtc_malloc/… stay. */
...
#endif /* GW_CORE_BRIDGE_DISABLE_SDK_MALLOC */
